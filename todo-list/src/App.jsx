...
function App() {
  const [todos, setTodos] = useState([]); // Ensure the state is named 'todos'
        ...
        <ul className="space-y-2">
          {todos.map((todo) => (
            ...
            >
              ...
              <button
                onClick={() => setTodos(todos.filter((t) => t.id !== todo.id))} // Update setTodos, not setTodo
                className="ml-2 border-none p-2 rounded-lg bg-red-500 text-white hover:bg-gray-600"
              >
                Delete
              </button>
            </li>
